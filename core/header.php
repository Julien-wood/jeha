 ...
 <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        ...
        <i class="bi bi-phone d-flex align-items-center ms-4"><a href="tel:+22890319573">228 90 31 95 73</a></i>
        <i class="bi bi-phone d-flex align-items-center ms-4"><a href="tel:+22892030846">228 92 03 08 46</a></i>
      </div>
    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="index.php?page=service">Activités</a></li>
